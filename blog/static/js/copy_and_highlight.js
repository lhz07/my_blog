...
function parseAnchor(code, buttonsGroup, comment_sign) {
  ...
  const visibleOnText = "Show hidden lines";
  const visibleOffText = "Hide lines";
  visibleBtn.innerHTML = visibleOn;
  visibleBtn.title = visibleOnText;
  ...
  visibleBtn.onclick = () => {
    ...
    if (showingOnlyAnchors) {
      ...
      visibleBtn.title = visibleOffText;
